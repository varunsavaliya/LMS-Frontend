...
export const CustomButton = ({
  ...
  const getButtonClass = (designType) => {
    switch (designType) {
      case "submit":
        return "bg-yellow-600 hover:bg-transparent border hover:text-yellow-600 border-yellow-600 rounded-lg py-1 mt-6 transition-all ease-in-out duration-300 font-semibold text-lg";
      case "primary":
